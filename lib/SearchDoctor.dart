        ...
        child:Column(
          children: [
            ...
            Container(
                  ...
                  child:Center(child: Text('Localisation',style:TextStyle(color:Color(0xff6db0d0)),)),
                ),
                Container(
                  height: 25,
                  width: 100,
                  ...
                  child:Center(child: Text('Disponibilité',style:TextStyle(color:Color(0xff6db0d0)),)),
                ),
                ...
                Container(
                  ...
                  child:Center(child: Text('Prix',style:TextStyle(color:Color(0xff6db0d0),)),
                ),
                ),
             ],
            ),
                      ...
                      child:Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text('Ahmed Abdelaziz',style:TextStyle(fontWeight:FontWeight.bold,color: Color(0xff7BC1B7),),)
                                ],
                              ),
                       ...
                       RatingBar.builder(
                        ...
                        Container(
                          ...
                          width: 80,
                            decoration: BoxDecoration(
                                                            color:Color.fromARGB(255, 6, 199, 170),
